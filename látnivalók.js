...
for (const elem of látnivalótomb) {
    sz+=`
    <div class="col-sm-12">
    <div class="dobozdiv">
...
document.getElementById("látnivalóAdatok").innerHTML=sz